  ...
  return (
    <>
      <SafeAreaView style={styles.window}>
        ...
        <Header left={<IconButton icon="close" color={activeColor} size={24} onPress={closeWindow} />} transparent/>
        <ScrollView style={{ flex: 1, paddingHorizontal: 12 }}>
          ...
          <View style={styles.textFieldsView}>
            ...
            <View style={styles.textField}>
              ...
              />
              <IconButton 
                icon={showPassword === false ? "eye-off-outline" : "eye-outline"} 
          ...
          <Button mode="full" onPress={loginWithEmailAndPassword} text="Login" icon="chevron-right" style={{ alignSelf: "flex-end"}} loading={loading}/>
        </ScrollView>
        </ImageBackground>
      </SafeAreaView>
      {message && (
        <Alert message={message.message ? message.message : message} action={true}/>
      )}
    </>
  )
}
